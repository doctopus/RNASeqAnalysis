...
##### Setup Project ----
setupProject(project) ; print(paste0("Working dir is: ", getwd()))
...
#### Merge Feature Counts on the Windows Computer with access to Isilon in W Drive ----

# Project specific output if any
#output_dir <- "C:/Users/beherat2/Dropbox/Clinic3.0/Developer/RStudio/RNASeqAnalysis/RNASeq-ADMA/output/working"

###Select and Merge FC File
source_dir <- "W:/Shared/LRI/Labs/yuj2lab/Tapas/ADMA"
# source_dir <- "/mnt/beegfs/beherat2/kinase_RNASeq/data"
#fc_dir <- paste0(input_dir, "/subread/featureCounts/")
fc_dir <- paste0(source_dir, "/FeatureCounts/")
#fc_dir <- paste0("../../../Documents/Clinic3.0/kinaseRNASeq/FeatureCounts/")

# Get list of bam files from HPC to the input folder and then run following
...
#### Following DESeq Steps Transferred to Independent File DESeq2Analysis.R ----
### create DESeq Object ====
